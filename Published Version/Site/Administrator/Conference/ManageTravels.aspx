<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoAdmin.Master"
    AutoEventWireup="true" CodeBehind="ManageTravels.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.Conference.ManageTravels" %>
            ...
            <dx:ASPxGridView ID="TravelsGrid" runat="server" AutoGenerateColumns="False" DataSourceID="DSTravels"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="TransportationTypeID" ShowInCustomizationForm="True"
                        VisibleIndex="4" Caption="Transportation Type">
                        <PropertiesComboBox DataSourceID="TransportationTypeDS" TextField="TypeName" ValueField="ID"
                            ValueType="System.Int32">
                        </PropertiesComboBox>
                        <EditFormSettings ColumnSpan="2" />
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataMemoColumn FieldName="Description" VisibleIndex="6">
                        <EditFormSettings ColumnSpan="2" />
