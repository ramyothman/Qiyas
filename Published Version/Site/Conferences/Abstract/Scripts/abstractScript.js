...
function OnNextButtonClick() {
    ...
    if (areEditorsValid) {
        ...
        if ((pc.GetActiveTabIndex() + 1) == 4) {
            ...
            AbstractSubmissionHidden.Set("AbstractTitleHtmlEditor", AbstractTitleHtmlEditor.GetHtml());
            AbstractSubmissionHidden.Set("AbstractMethodsHtmlEditor", AbstractMethodsHtmlEditor.GetHtml());
            AbstractSubmissionHidden.Set("AbstractBackgroundHtmlEditor", AbstractBackgroundHtmlEditor.GetHtml());
            AbstractSubmissionHidden.Set("AbstractResultsHtmlEditor", AbstractResultsHtmlEditor.GetHtml());
            AbstractSubmissionHidden.Set("AbstractConclusionHtmlEditor", AbstractConclusionHtmlEditor.GetHtml());
