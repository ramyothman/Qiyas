<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs" Inherits="SocioBuilderSite.Controls.IRB.LoginControl" %>
...
<div runat="server" id="LoginScreen">
  ...
  <div>
    ...
    <div class="forgot"><a href="~/IRB/RegisterUp.aspx" runat="server" id="signupLink">Signup for a new account?</a><br /></div>
