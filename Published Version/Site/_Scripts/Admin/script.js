$(document).ready(function() {
	...
	var $content = $('#content');
		...
		/* Charts
		/*----------------------------------------------------------------------*/
		if($content.find('table.chart') != null)
		...
		/* Fileexplorer
		/*----------------------------------------------------------------------*/
		if($content.find('div.fileexplorer') != null)
		...
		/*----------------------------------------------------------------------*/
		if($content.find('div.calendar') != null)
		...
		/* Gallery
		/*----------------------------------------------------------------------*/
		if($content.find('ul.gallery') != null)
		...
		if($content.find('input[title]') != null)
		...
		/* Accordions
		/*----------------------------------------------------------------------*/
		if($content.find('div.accordion') != null)
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
		...
		/* Callback for Slider
		/*----------------------------------------------------------------------*/
			if($content.find('div.slider#slider_callback') != null)
		...
		/* http://themeforest.Jareeda.me/whitelabel/doc-sliders.html
		/*----------------------------------------------------------------------*/
			if($content.find('div.slider#slider_mousewheel') != null)
			...
			if($('#slider_mousewheel_left, #slider_mousewheel_right') != null)
		...
		/* http://themeforest.Jareeda.me/whitelabel/widgets.html
		/*----------------------------------------------------------------------*/
			if($content.find('.clearLocalStorage') != null)
		...
		/* http://themeforest.Jareeda.me/whitelabel/doc-store.html
		/*----------------------------------------------------------------------*/
		...
		/* http://themeforest.Jareeda.me/whitelabel/form.html
		/*----------------------------------------------------------------------*/
			if($('#formfiller') != null)
		...
		/* http://themeforest.Jareeda.me/whitelabel/gallery.html
		/*----------------------------------------------------------------------*/
			if($content.find('ul.gallery') != null)
			$content.find('ul.gallery').wl_Gallery({
		...
		/* http://themeforest.Jareeda.me/whitelabel/dialogs_and_buttons.html
		/*----------------------------------------------------------------------*/
		...
		/*----------------------------------------------------------------------*/
		/* Breadcrumb Demos
		/* http://themeforest.Jareeda.me/whitelabel/breadcrumb.html
		/*----------------------------------------------------------------------*/
