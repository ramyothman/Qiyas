...
namespace BusinessLogicLayer
{
    public class Common
    {
        ...
        public static BusinessLogicLayer.Components.BedManagement.AdmissionStayChangeLogic AdmissionStayChangeLogic = new Components.BedManagement.AdmissionStayChangeLogic();
        public static BusinessLogicLayer.Components.BedManagement.AdmissionStayTypeLogic AdmissionStayTypeLogic = new Components.BedManagement.AdmissionStayTypeLogic();
        public static BusinessLogicLayer.Components.BedManagement.ConsultantLogic ConsultantLogic = new Components.BedManagement.ConsultantLogic();
        public static BusinessLogicLayer.Components.BedManagement.DischargeTypeLogic DischargeTypeLogic = new Components.BedManagement.DischargeTypeLogic();
        public static BusinessLogicLayer.Components.BedManagement.PatientAdmissionLogic PatientAdmissionLogic = new Components.BedManagement.PatientAdmissionLogic();
        public static BusinessLogicLayer.Components.BedManagement.WardBedLogic WardBedLogic = new Components.BedManagement.WardBedLogic();
        public static BusinessLogicLayer.Components.BedManagement.WardLogic WardLogic = new Components.BedManagement.WardLogic();
        public static BusinessLogicLayer.Components.BedManagement.WardRoomLogic WardRoomLogic = new Components.BedManagement.WardRoomLogic();
        public static BusinessLogicLayer.Components.BedManagement.WardRoomTypeLogic WardRoomTypeLogic = new Components.BedManagement.WardRoomTypeLogic();
        public static BusinessLogicLayer.Components.BedManagement.WardSpecialityLogic WardSpecialityLogic = new Components.BedManagement.WardSpecialityLogic();
        #endregion
        ...
        public static Components.HumanResources.DepartmentLanguagesLogic DepartmentLanguagesLogic = new Components.HumanResources.DepartmentLanguagesLogic();
        public static Components.HumanResources.DepartmentsLogic DepartmentsLogic = new Components.HumanResources.DepartmentsLogic();
        public static Components.HumanResources.DivisionsLogic DivisionsLogic = new Components.HumanResources.DivisionsLogic();
        public static Components.HumanResources.EmployeesLogic EmployeesLogic = new Components.HumanResources.EmployeesLogic();
        public static Components.HumanResources.OrganizationLanguagesLogic OrganizationLanguagesLogic = new Components.HumanResources.OrganizationLanguagesLogic();
        public static Components.HumanResources.OrganizationsLogic OrganizationsLogic = new Components.HumanResources.OrganizationsLogic();
        #endregion
        ...
        #region Organization
        public static Components.Organization.ResearchChairLanguagesLogic ResearchChairLanguagesLogic = new Components.Organization.ResearchChairLanguagesLogic();
        public static Components.Organization.ResearchChairsLogic ResearchChairsLogic = new Components.Organization.ResearchChairsLogic();
        public static Components.Organization.SpecialityLogic SpecialityLogic = new Components.Organization.SpecialityLogic();
        #endregion
        ...
        #region Eligibility
        public static BusinessLogicLayer.Components.Eligibility.EligibilityDepartmentActionLogic EligibilityDepartmentActionLogic = new Components.Eligibility.EligibilityDepartmentActionLogic();
        public static BusinessLogicLayer.Components.Eligibility.EligibleRequestStatusHistoryLogic EligibleRequestStatusHistoryLogic = new Components.Eligibility.EligibleRequestStatusHistoryLogic();
        public static BusinessLogicLayer.Components.Eligibility.EligibleLogic EligibleLogic = new Components.Eligibility.EligibleLogic();
        public static BusinessLogicLayer.Components.Eligibility.EligibleFilesLogic EligibleFilesLogic = new Components.Eligibility.EligibleFilesLogic();
        public static BusinessLogicLayer.Components.Eligibility.EligibilityStatusLogic EligibilityStatusLogic = new Components.Eligibility.EligibilityStatusLogic();

        public static BusinessLogicLayer.Components.Eligibility.EligibilityDepartmentLogic EligibilityDepartmentLogic = new Components.Eligibility.EligibilityDepartmentLogic();
        public static BusinessLogicLayer.Components.Eligibility.EligibilityConsultantLogic EligibilityConsultantLogic = new Components.Eligibility.EligibilityConsultantLogic();
