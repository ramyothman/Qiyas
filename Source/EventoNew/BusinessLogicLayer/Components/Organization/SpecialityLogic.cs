...
namespace BusinessLogicLayer.Components.Organization
{
	...
	public partial class SpecialityLogic : BusinessLogic
	{
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
         public List<Speciality> GetAll()
         {
             ...
             if(_specialityList == null)
                 ...
                 if(reader["BedDisplayCode"] != DBNull.Value)
                     _speciality.BedDisplayCode = Convert.ToString(reader["BedDisplayCode"]);
		...
		public bool Insert(Speciality speciality)
		{
			...
			bool endedSuccessfuly = specialityComponent.InsertNewSpeciality( ref autonumber,  speciality.SpecialityCode,  speciality.SpecialityName,  speciality.BedDisplayCode);
			if(endedSuccessfuly)
			{
		...
		public bool Insert( ref int SpecialityId,  string SpecialityCode,  string SpecialityName,  string BedDisplayCode)
		{
			SpecialityDAC specialityComponent = new SpecialityDAC();
