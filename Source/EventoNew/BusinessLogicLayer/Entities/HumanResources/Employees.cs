...
namespace BusinessLogicLayer.Entities.HumanResources
{
	...
	public class Employees : Entity
	{
     ...
     [NotNullValidator]
     [RangeValidator(1,RangeBoundaryType.Inclusive,Int32.MaxValue,RangeBoundaryType.Inclusive,Ruleset="Entity", MessageTemplate="EmployeeId Not Entered")]
     ...
     [RangeValidator(1,RangeBoundaryType.Inclusive,Int32.MaxValue,RangeBoundaryType.Inclusive,Ruleset="Entity", MessageTemplate="DepartmentId Not Entered")]
     ...
     [RangeValidator(1,RangeBoundaryType.Inclusive,Int32.MaxValue,RangeBoundaryType.Inclusive,Ruleset="Entity", MessageTemplate="DivisionId Not Entered")]
        [DataObjectField(false,false,true)]
     ...
     [RangeValidator(1,RangeBoundaryType.Inclusive,Int32.MaxValue,RangeBoundaryType.Inclusive,Ruleset="Entity", MessageTemplate="ManagerId Not Entered")]
        [DataObjectField(false,false,true)]
