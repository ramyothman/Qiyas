...
namespace DataAccessLayer.DataAccessComponents.ContentManagement
{
	...
	public class ArticleDAC : DataAccessComponent
	{
		...
		/// </summary>
		public bool InsertNewArticle( int articleId,  int siteSectionId,  int creatorId,  int articleStatusId,  int authorId,  DateTime postDate,  bool allowLanguageSpecificTags,  Guid rowGuid,  DateTime modifiedDate,  int commentsTypeId,  bool enableModeteration)
		{
		...
		/// </summary>
		public bool InsertNewArticle( int articleId,  int siteSectionId,  int creatorId,  int articleStatusId,  int authorId,  DateTime postDate,  bool allowLanguageSpecificTags,  Guid rowGuid,  DateTime modifiedDate,  int commentsTypeId,  bool enableModeteration,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("InsertNewArticle");
				Database.AddInParameter(command,"ArticleId",DbType.Int32,articleId);
				Database.AddInParameter(command,"SiteSectionId",DbType.Int32,siteSectionId);
		...
		/// </summary>
		public bool UpdateArticle( int articleId, int siteSectionId, int creatorId, int articleStatusId, int authorId, DateTime postDate, bool allowLanguageSpecificTags, Guid rowGuid, DateTime modifiedDate, int commentsTypeId, bool enableModeteration, int oldarticleId)
		{
		...
		/// </summary>
		public bool UpdateArticle( int articleId, int siteSectionId, int creatorId, int articleStatusId, int authorId, DateTime postDate, bool allowLanguageSpecificTags, Guid rowGuid, DateTime modifiedDate, int commentsTypeId, bool enableModeteration, int oldarticleId,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("UpdateArticle");
		    		Database.AddInParameter(command,"ArticleId",DbType.Int32,articleId);
		    		Database.AddInParameter(command,"SiteSectionId",DbType.Int32,siteSectionId);
