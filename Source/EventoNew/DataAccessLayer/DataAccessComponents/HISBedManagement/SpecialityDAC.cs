...
namespace DataAccessLayer.DataAccessComponents.HISBedManagement
{
	...
	public class SpecialityDAC : DataAccessComponent
	{
		...
		/// </summary>
		public bool InsertNewSpeciality( ref int specialityId,  string specialityCode,  string specialityName,  string specialityAbbreviation)
		{
				...
				Database.AddInParameter(command,"SpecialityAbbreviation",DbType.String,specialityAbbreviation);
				bool _status = false;
		...
		/// </summary>
		public bool InsertNewSpeciality( ref int specialityId,  string specialityCode,  string specialityName,  string specialityAbbreviation,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("InsertNewSpeciality");
				Database.AddOutParameter(command,"SpecialityId",DbType.Int32,Int32.MaxValue);
				Database.AddInParameter(command,"SpecialityCode",DbType.String,specialityCode);
		...
		public DbCommand InsertNewSpecialityCommand()
		{
			try
			{
				...
				Database.AddInParameter(command,"SpecialityAbbreviation",DbType.String,"SpecialityAbbreviation",DataRowVersion.Current);
				return command;
			}			catch(Exception ex)
			{
				throw ex;
		...
		/// </summary>
		public bool UpdateSpeciality( string specialityCode, string specialityName, string specialityAbbreviation, int oldspecialityId)
		{
		...
		/// </summary>
		public bool UpdateSpeciality( string specialityCode, string specialityName, string specialityAbbreviation, int oldspecialityId,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("UpdateSpeciality");
