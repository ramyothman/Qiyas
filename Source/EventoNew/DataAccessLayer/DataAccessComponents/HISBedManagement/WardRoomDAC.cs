...
namespace DataAccessLayer.DataAccessComponents.HISBedManagement
{
	...
	public class WardRoomDAC : DataAccessComponent
	{
		...
		/// </summary>
		public bool InsertNewWardRoom( ref int wardRoomId,  int wardId,  int roomTypeId,  string roomCode,  string roomDescription,  string roomColor,  int capacity,  int bedsNumber,  string roomPhone,  bool isClosed,  string closingReason)
		{
				...
				Database.AddInParameter(command,"RoomCode",DbType.String,roomCode);
				Database.AddInParameter(command,"RoomDescription",DbType.String,roomDescription);
				...
				Database.AddInParameter(command,"ClosingReason",DbType.String,closingReason);
				bool _status = false;
		...
		/// </summary>
		public bool InsertNewWardRoom( ref int wardRoomId,  int wardId,  int roomTypeId,  string roomCode,  string roomDescription,  string roomColor,  int capacity,  int bedsNumber,  string roomPhone,  bool isClosed,  string closingReason,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("InsertNewWardRoom");
				Database.AddOutParameter(command,"WardRoomId",DbType.Int32,Int32.MaxValue);
				Database.AddInParameter(command,"WardId",DbType.Int32,wardId);
		...
		public DbCommand InsertNewWardRoomCommand()
		{
			try
			{
				...
				Database.AddInParameter(command,"RoomCode",DbType.String,"RoomCode",DataRowVersion.Current);
				Database.AddInParameter(command,"RoomDescription",DbType.String,"RoomDescription",DataRowVersion.Current);
				...
				Database.AddInParameter(command,"ClosingReason",DbType.String,"ClosingReason",DataRowVersion.Current);
				return command;
			}			catch(Exception ex)
			{
				throw ex;
		...
		/// </summary>
		public bool UpdateWardRoom( int wardId, int roomTypeId, string roomCode, string roomDescription, string roomColor, int capacity, int bedsNumber, string roomPhone, bool isClosed, string closingReason, int oldwardRoomId)
		{
		...
		/// </summary>
		public bool UpdateWardRoom( int wardId, int roomTypeId, string roomCode, string roomDescription, string roomColor, int capacity, int bedsNumber, string roomPhone, bool isClosed, string closingReason, int oldwardRoomId,DbTransaction transaction)
		{
                 DbCommand command = Database.GetStoredProcCommand("UpdateWardRoom");
