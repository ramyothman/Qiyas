CREATE TABLE [Conference].[ConferenceSpeakersLanguage] (
    ...
    [ConferenceSpeakerParentId] INT             NOT NULL,
    CONSTRAINT [PK_ConferenceSpeakersLanguage] PRIMARY KEY CLUSTERED ([ConferenceSpeakerId] ASC)
);
