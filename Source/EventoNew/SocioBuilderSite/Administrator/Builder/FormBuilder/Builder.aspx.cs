...
namespace SocioBuilderSite.Administrator.Builder.FormBuilder
{
    public partial class Builder : System.Web.UI.Page
    {
        ...
        private SurveyJSON GetJSONSurvey()
        {
            ...
            if (CurrentSurvey != null)
            {
                ...
                txtSurveySubmitReply.Text = CurrentSurvey.ConfirmationText;
            }
        ...
        protected void saveCallBack_Callback(object source, DevExpress.Web.ASPxCallback.CallbackEventArgs e)
        {
            ...
            using (JsonReader jsonReader = new JsonTextReader(reader))
            {
                ...
                if (p != null)
                {
                    ...
                    CurrentSurvey.ConfirmationText = txtSurveySubmitReply.Text;
