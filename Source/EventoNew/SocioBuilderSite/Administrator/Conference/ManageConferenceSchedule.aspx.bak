<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoAdmin.Master"
    AutoEventWireup="true" CodeBehind="ManageConferenceSchedule.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.Conference.ManageConferenceSchedule" %>
            ...
            <dx:ASPxGridView ID="ConferenceProgramGrid" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="Program" Visible="false"
                        FieldName="ConferenceProgramId" VisibleIndex="2">
                    ...
                    <dx:GridViewDataDateColumn FieldName="StartTime" VisibleIndex="5">
                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm tt" EditFormat="DateTime">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn FieldName="EndTime" VisibleIndex="6">
                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm tt" EditFormat="DateTime">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
