<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoAdmin.Master" AutoEventWireup="true" CodeBehind="ManageConferences.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.Conference.ManageConferences" %>
...
<EditFormSettings ColumnSpan="2"></EditFormSettings>
                    ...
                    <dx:GridViewDataCheckColumn FieldName="IsActive" VisibleIndex="6">
<EditFormSettings ColumnSpan="0" Visible="True"></EditFormSettings>
	...
	Uploader_OnUploadComplete(e);
            ...
            <asp:ObjectDataSource ID="ConferenceObjectDS" runat="server" 
                ...
                <asp:ObjectDataSource ID="VenueObjectDS" runat="server" 
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" 
                    TypeName="BusinessLogicLayer.Components.Conference.VenuesLogic">
                </asp:ObjectDataSource>
