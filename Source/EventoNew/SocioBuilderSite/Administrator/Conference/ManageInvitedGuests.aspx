<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoAdmin.Master"
    AutoEventWireup="true" CodeBehind="ManageInvitedGuests.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.Conference.ManageInvitedGuests" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
     <div class="g12 widgets">
			<div class="widget widget-header-blue" id="widget_charts" data-icon="graph-dark">
				<h3 class="handle">Manage Invited Guests</h3>
				<div class="inner-content">
        <asp:HyperLink ID="hlNewSpeaker" runat="server" Text="New Invited Guest" NavigateUrl="SaveInvitedGuests.aspx"></asp:HyperLink>
        
            <dx:ASPxGridView ID="SpeakersGrid" ClientInstanceName="SpeakersGrid" runat="server"
                AutoGenerateColumns="False" DataSourceID="SpeakersObjectDS" KeyFieldName="ID">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption=" " VisibleIndex="1">
                        <DataItemTemplate>
                            <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%#"SaveInvitedGuests.aspx?ID="+Eval("ID").ToString()%>'
                                Text="Edit"></asp:HyperLink>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="ID" VisibleIndex="1" Caption="Id" ReadOnly="True"
                        Visible="false">
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="Guest Name" FieldName="PersonId" VisibleIndex="3">
                    ...
                    <dx:GridViewDataTextColumn Caption="Photo" FieldName="SpeakerImage" VisibleIndex="7">
                        <DataItemTemplate>
                            <asp:Image ID="SpeakerImage" runat="server" ImageUrl='<%#Eval("SpeakerImage")%>'
                ...
                <Templates>
                    <DetailRow>
                    <asp:HyperLink ID="hlNewSpeaker" runat="server" Text="New Invited Guest" NavigateUrl='<%#"SaveARInvitedGuests.aspx?ParentID="+ Session["ParentID"].ToString()%>'></asp:HyperLink>
                                        
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
                            DataSourceID="dsInvitedguestlang" KeyFieldName="ID" OnBeforePerformDataSelect="ASPxGridView1_BeforePerformDataSelect">
                           <Columns>
                    <dx:GridViewCommandColumn VisibleIndex="0" Caption=" ">
                        <DeleteButton Visible="True">
                        </DeleteButton>
                    ...
                    <dx:GridViewDataTextColumn Caption=" " VisibleIndex="1">
                        <DataItemTemplate>
                            <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%#"SaveARInvitedGuests.aspx?ID="+Eval("ID").ToString()%>'
                                Text="Edit"></asp:HyperLink>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="ID" VisibleIndex="1" Caption="Id" ReadOnly="True"
                    ...
                    <dx:GridViewDataTextColumn Caption="Photo" FieldName="SpeakerImage" VisibleIndex="7">
                        ...
                        <PropertiesComboBox DataSourceID="dsLanguages" TextField="Name" ValueField="LanguageId"></PropertiesComboBox>
                                ...
                                <dx:GridViewDataTextColumn FieldName="parentID" VisibleIndex="22" Visible="false">
                                </dx:GridViewDataTextColumn>
                ...
                TypeName="BusinessLogicLayer.Components.ContentManagement.LanguageLogic">
                        ...
                        <asp:ObjectDataSource ID="dsInvitedguestlang" runat="server" 
                            DeleteMethod="Delete" InsertMethod="Insert" 
                            OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" 
                            TypeName="BusinessLogicLayer.Components.Conference.InvitedGuestsLanguageLogic" 
                            UpdateMethod="Update">
                            <DeleteParameters>
            ...
            <asp:ObjectDataSource ID="SpeakersObjectDS" runat="server" DeleteMethod="Delete"
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" TypeName="BusinessLogicLayer.Components.Conference.InvitedGuestsLogic">
                <DeleteParameters>
                    <asp:Parameter Name="Original_Id" Type="Int32" />
                </DeleteParameters>
            </asp:ObjectDataSource>
