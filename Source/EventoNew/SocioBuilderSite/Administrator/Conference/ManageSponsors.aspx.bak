<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoAdmin.Master" AutoEventWireup="true" CodeBehind="ManageSponsors.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.Conference.ManageSponsors" %>
     ...
     <div class="g12 widgets">
            ...
            <dx:ASPxGridView ID="SponsorsGrid" ClientInstanceName="SponsorsGrid" onrowinserting="SponsorGrid_RowInserting" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="Conference" FieldName="ConferenceId" VisibleIndex="3">
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="SponsorType" VisibleIndex="4">
                    ...
                    <dx:GridViewDataImageColumn FieldName="SponsorImage" VisibleIndex="5">
