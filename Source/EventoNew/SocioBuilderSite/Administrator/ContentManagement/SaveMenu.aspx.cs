...
{
    public partial class SaveMenu : AdminBasePage
    {
        ...
        private void FillControls()
        {
            if (Request.QueryString["ID"] != null)
            {
                ...
                else if (_Menu.MenuEntityTypeId == (int)MenuEntityTypeEnum.SiteContent)
                {
                    ...
                    SitePage page = new SitePageLogic().GetByID(_Menu.ContentEntityId);
        ...
        {
            Response.Redirect("ManageMenus.aspx");
        }
        ...
        private void GetFormValues()
        {
            ...
            else if (divSiteSection.Visible)
            {
                ...
                _Menu.PagePath = "~/Conference/ArticlesView.aspx?code=" + _Menu.ContentEntityId;
            }
