<%@ Page Theme="LoginEvento" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SocioBuilderSite.Administrator.Login.Default" %>
...
<body>
    <form id="form1" runat="server">
     <div class="wrapper">
	<div class="logo">
		<a href="#"><img runat="server" src="~/App_Themes/LoginEvento/images/logo.png" alt="Logo" width="662" height="208" /></a>
	</div>
...
<%--	<p><a href="#" class="forget">Forget you password?</a></p>--%>
	<div class="footer"><p>2012 evento copyright . all rights reserved</p></div>
</div>
