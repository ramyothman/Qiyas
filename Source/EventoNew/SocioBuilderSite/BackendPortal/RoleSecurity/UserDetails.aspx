<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdministrationMaster.Master" AutoEventWireup="true" CodeBehind="UserDetails.aspx.cs" Inherits="SocioBuilderSite.BackendPortal.RoleSecurity.UserDetails" %>
...
<script type="text/javascript">
    ...
    function LoadPhones() {
        ...
        if (personPhones != null) {
            var i = 1;
            for (i = 1; i < personPhones.length; i++) {
...
<div class="title title-spacing">
        <h2>
            <span runat="server" id="titleProfileHolder"></span>Manage User
        </h2>
        This page allows you to save user information
    </div>
    <div class="rbm-editform">
    <table>
        <tr>
