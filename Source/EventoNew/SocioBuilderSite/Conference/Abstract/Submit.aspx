<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/EventoMain.Master" AutoEventWireup="true" CodeBehind="Submit.aspx.cs" Inherits="SocioBuilderSite.Conference.Abstract.Submit" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControlAbstract" runat="server" SupportsDisabledAttribute="True">
                             ...
                             <div class="regFieldHolder">
                                ...
                                <dx:ASPxComboBox CssClass="regInput" ID="AbstractCategoryCombo" 
                                        ClientInstanceName="AbstractCategoryCombo" runat="server" SelectedIndex="0" 
		...
		e.isValid = true;
                                        ...
                                        TypeName="BusinessLogicLayer.Components.Conference.ConferenceCategoryLogic">
                                          <SelectParameters>
                                              <asp:SessionParameter DefaultValue="0" Name="ConferenceId" 
                                                  SessionField="CurrentConferenceID" Type="Int32" />
                                          </SelectParameters>
                                ...
                                <div class="regFieldHolder-New">
                                    <label class="label-main">Title</label>
                                       <dx:ASPxMemo runat="server" ID="AbstractTitleMemoEditor" ClientInstanceName="AbstractTitleMemoEditor" Width="600px" Height="210px"></dx:ASPxMemo>    
                                    </div>
                                    
                                    <div class="regFieldHolder-New">
                                    <label class="label-main">Background</label>
                                    <dx:ASPxMemo runat="server" ID="AbstractBackgroundMemoEditor" ClientInstanceName="AbstractBackgroundMemoEditor" Width="600px" Height="210px"></dx:ASPxMemo>
                                    </div>

                                    <div class="regFieldHolder-New">
                                    <label class="label-main">Methods</label>
                                        <dx:ASPxMemo runat="server" ID="AbstractMethodsMemoEditor" ClientInstanceName="AbstractMethodsMemoEditor" Width="600px" Height="210px"></dx:ASPxMemo>
                                    </div>

                                    <div class="regFieldHolder-New">
                                    <label class="label-main">Results</label>
                                    <dx:ASPxMemo runat="server" ID="AbstractResultsMemoEditor" ClientInstanceName="AbstractResultsMemoEditor" Width="600px" Height="210px"></dx:ASPxMemo>
                                        
                                    </div>

                                    <div class="regFieldHolder-New">
                                    <label class="label-main">Conclusion</label>
                                    <dx:ASPxMemo runat="server" ID="AbstractConclusionMemoEditor" ClientInstanceName="AbstractConclusionMemoEditor" Width="600px" Height="210px"></dx:ASPxMemo>
                                    </div>
...
<ValidationSettings AllowedFileExtensions=".doc,.docx,.rtf,.pdf">
                                            </ValidationSettings>
                ...
                <dx:TabPage ClientEnabled="False" Name="Finish" Text="Finish">
                    <ContentCollection>
                        ...
                        <div class="tabPageContent finishArea">
                                    ...
                                    <dx:ASPxButton Visible="false" ID="btnGoToSchedule" runat="server" Text="Abstract Status"
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxButton ID="btnFinish" ClientInstanceName="btnFinish" runat="server" Image-Url="~/images/buttons/finish.png"
                                AutoPostBack="false"   ClientVisible="false" UseSubmitBehavior="true">
